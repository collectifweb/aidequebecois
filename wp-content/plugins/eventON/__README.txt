...
== Changelog ==
= 4.8.2 (2025-1-31) = 
ADDED: dynamic_select element for EVO_General_Elements()
FIXED: Minor settings styles
FIXED: capitalized month name in event card
FIXED: custom repeat addition not saving correct for certain date formats
FIXED: evo_ajax_lightbox_form_submit()to include passed on nonce
FIXED: Eventon settings download all events as ICS format not working
FIXED: add to calendar link causing error in google schema
FIXED: custom fonts support for custom meta data ul li content
FIXED: Related events configure button reloading page
FIXED: default link text color on event details
FIXED: custom map marker not working for single event page
UPDATED: Schedule view RTL styles
UPDATED: pluggable filters for template loading
UPDATED: Moved event status reason content to separate editable item for eventtop
REMOVED: Cancelled events overlay to utilize cancelled event tag

= 4.8.1 (2025-1-15) = 
ADDED: EventON Settings save via ajax
FIXED: Add to calendar not working
FIXED: Missing repeat interval value for add to cal link
FIXED: settings saved message showing multiple times in header
FIXED: location image minimum height
FIXED: previously saved settings values to be maintained during new update
FIXED: loading button animation running on everything
FIXED: single event page colorful eventtop not using settings values
FIXED: image attachment in admin not working sometimes
FIXED: custom meta fields lightbox to hide once save changes
FIXED: option in event edit to show link to open location address in google maps
UPDATED: related events layout in eventcard

= 4.8 (2025-1-13) = 
ADDED: event edit date picker to highlight date range
ADDED: optional image field for custom meta fields
ADDED: optional textarea for custom meta fields button
ADDED: ability to click location image for full lightbox view
ADDED: Ability to set organizer image height in lightbox
...
ADDED: Organizer phone number
ADDED: Organizer column to all event edit page
ADDED: language settings to be saved via ajax
FIXED: virtual events zoom config button not appearing at first load
FIXED: CSV export of all events to include custom meta field button link
FIXED: license activation not working
FIXED: add to calendar time not correct for all day events
FIXED: eventcard details coming up empty after update
FIXED: webhook lightbox not loading
FIXED: EventON Settings side tabs moving page up when clicked
FIXED: eventtop appearance color not taking into effect on calendar
FIXED: shortcode generator separate copy code button
FIXED: language custom meta field empty string error
FIXED: filter_hide_indicator = yes still showing the checkmark
FIXED: certain text strings translations are not going through
FIXED: multi data type image not saving and showing
FIXED: location edit page showing multiple image fields
FIXED: multi date types image to be clickable for full view in lightbox
FIXED: lightbox full image aspect ratio issues
FIXED: download event as CSV missing location and organizer information
FIXED: location and eventattendancemode google schema error
FIXED: webhooks values getting erased after saving settings
FIXED: Organizer map not working
UPDATED: custom meta fields settings moved to lightbox
UPDATED: events list in admin design and layout
UPDATED: event timezone to be select2 field with easy search on edit event
UPDATED: backend date picker UI design
UPDATED: font awesome to 6.7.1
...
= 4.7.2 (2024-11-6) =
ADDED: sanitize_post() for evo_hepler
...
FIXED: tile text color luma calculation for eventon_is_hex_dark()
...
UPDATED: detailed_button element in EVO_General_Elements()
...
= 4.7 (2024-10-4) =
ADDED: pluggable filter evo_loaded_scripts_styles to check load eventon scripts
...
FIXED: admin_test_email with nonce verification
...
= 4.6.7 (2024-7-18) =
FIXED: evo_cal_events_in_range() error with SC
FIXED: quick edit span to end time not working
FIXED: end time is shown in view in my time when set to hide
FIXED: wp_rand() instead of rand()
FIXED: get_terms() to match with latest wp function
FIXED: vulnerability with import_settings()
UPDATED: implemented wp_cache_set() for custom database queries
UPDATED: evo_get_frontend_filter_tax_{x} filter to support pluggability
...
FIXED: default ux_val to be 0
FIXED: get_supported_shortcode_atts() errors
...
ADDED: new EVO_Cal_Shortcode() class for processing shortcodes within calendar
...
FIXED: filter_hide_indicator not working
...
FIXED: color picker interactivity
UPDATED: POT file
