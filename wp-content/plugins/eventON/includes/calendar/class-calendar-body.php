		...
		public function calendar_shell_footer( $footer_data = true ){
			...
			<?php
				if(!empty($args['ics']) && $args['ics']=='yes'){
					...
					echo '<a class="evcal_btn download_ics" href="'. esc_url( $export_url_all ) .'" style="margin-top:10px"><em class="fa fa-calendar-plus-o" ></em> '. evo_lang('Download all events as ICS file').'</a>';
				}
