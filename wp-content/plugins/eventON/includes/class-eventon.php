...
final class EventON {
	...
	public $lang = 'L1';
	public $assets_path, $cal, $calendar, $evo_generator, $frontend,$mdt,$temp,$shortcodes,$ajax,$rest,$cron,$elements,$shortcode_gen,$lightbox,$gen_int,$evosv,$webhooks,$ajde, $evo_admin, $taxonomies, $helper, $settings, $admin_elements;
	...
	private function includes(){		
		...
		include_once( EVO_ABSPATH.'includes/elements/class-elements-trigs.php' );	
		include_once( EVO_ABSPATH.'includes/elements/class-elements-main.php' );	
		include_once( EVO_ABSPATH.'includes/elements/class-shortcode-fields.php' );	
		include_once( EVO_ABSPATH.'includes/elements/class-shortcode-data.php' );	
		...
		include_once( EVO_ABSPATH. 'includes/class-tax.php' );
		...
		include_once( EVO_ABSPATH. 'includes/calendar/class-calendar-shortcode.php' );
		...
		if ( $this->is_request('admin') ){	
			include_once( EVO_ABSPATH.'includes/elements/class-elements-admin.php' );	
			...
			include_once(EVO_ABSPATH.'includes/admin/class-admin-designer.php' );
	...
	public function init() {
		...
		if(is_admin()){
			...
			if( class_exists('EVO_Elements_Admin') ) $this->admin_elements	= new EVO_Elements_Admin();	
		}
