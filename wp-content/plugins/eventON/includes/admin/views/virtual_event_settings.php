...
<p style='padding-top: 15px;'><em>
	<b class='evopadb10 evodfx evofz16'><?php _e('Other Recommendations','eventon');?></b>
	<?php _e('Set Event Status value to "Moved Online" so proper schema data will be added to event to help search engines identify event type.','eventon');?>
