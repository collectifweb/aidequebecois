...
class evo_settings_settings{
		...
		return apply_filters('eventon_settings_tab1_arr_content', array(
			...
			array(
				...
				'fields'=> apply_filters('eventon_custom_icons', array(
					...
					array('id'=>'fs_fonti2','type'=>'fontation','name'=>__('EventCard Icons','eventon'),
						'variations'=>array(
							array('id'=>'evcal__ecI', 'type'=>'color', 'default'=>$preset_data['evo_color_1']),
			...
			'evcal_004aa'=> array(
				...
				'fields'=>array(
					...
					array('id'=>'evcal__note','type'=>'customcode','code'=>$this->eventtop_design_code()),
					array('type'=>'sub_section_close'),
			...
			,array(
				...
				'fields'=>array(	
					...
					array('type'=>'sub_section_open','name'=>__('Location & Organizer Images','eventon')),
						array('id'=>'evo_locimgheight','type'=>'text','name'=>__('Set event location image height (value in pixels)','eventon'), 'default'=>'eg. 400'),
						array('id'=>'evo_orgimgheight','type'=>'text','name'=>__('Set event organizer image height (value in pixels)','eventon'), 'default'=>'eg. 400'),
					array('type'=>'sub_section_close'),
					...
					array('type'=>'sub_section_open','name'=>__('Add to Calendar Options','eventon')),
						...
						array(
							'id'=>'evo_addtocal_slug',
							'type'=>'text',
							'name'=>__('Custom add to calendar / Download events as ICS URL slug'), 
							'default'=>'../export-events/',
							'legend'=> __('This will replace the current url slug for download events as ICS file.','eventon')
						),
					array('type'=>'sub_section_close'),
					...
					'fields'=> apply_filters('evo_settings_advanced', array(
						...
						*/
						...
						array('id'=>'evo_debug_mode',
							'type'=>'yesno',
							'name'=>__('Enable debug more (Beta)','eventon'), 
							'legend'=>__('Enabling this will add debug messages to wp debug log. Make sure to enable WP_DEBUG for this to work properly.','eventon')
						),
	...
	// html for diagnosis content
		function content_diag(){
			ob_start();
			?>
			<div class='backender_yn_sec'>
				<div class="diagnosis_row evosettings_field_child">
					<h4 class='acus_subheader'><?php _e('System Emailing Function test','eventon');?></h4>

					<p style='padding-bottom:10px;'>
						<label class='evodib evomarb5'><?php _e('Email address to send test email','eventon');?></label> 
						<span class='nfe_f_width'><input id='evo_admin_test_email_address'name='evo_email' type="text"></span>
					</p>
					<p><a id='evo_send_test_email' class="evo_admin_btn btn_triad"><?php _e('Send Test Email','eventon');?></a></p>

					<div class='evo_diag_email_msg evodn'>
						<p class='evodib evo_notice_msg evobr10 evomarb10i evopad5-10 good' style='min-height: auto;'>Test</p>
					</div>
	...
	// HTML code for export events in csv and ics format
		function export(){
			...
			<p><a class='evo_admin_btn btn_triad' href="<?php echo $exportURL;?>"><?php _e('CSV Format','eventon');?></a>  <a class='evo_admin_btn btn_triad' href="<?php echo $export_url_all;?>"><?php _e('ICS format','eventon');?></a></p>
			<?php 
			return  ob_get_clean();
		}
