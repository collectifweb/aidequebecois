			...
			array(
				...
				,array('id'=>'fc_mcolor','type'=>'multicolor','name'=>__('Multiple colors','eventon'),
					'variations'=>array(
						...
						array('id'=>'evo_color_link', 'default'=>$evo_color_link, 'name'=>'Link Color'),
					)
				),
				...
				array('id'=>'evo_dis_all_caps','type'=>'yesno',
					'name'=>__('Disable Auto all Caps for Title and Subtitle','eventon'),'legend'=> __('This will disable auto caps for subtitle and title text on calendar front-end view. This may help with proper display of special characters.','eventon')),
				...
				array('id'=>'evcal_fcx','type'=>'hiddensection_open','name'=>__('General Calendar','eventon'), 'display'=>'none'),
					array('id'=>'evose','type'=>'fontation','name'=>__('Social Media Icons','eventon'),
						'variations'=>array(
						array('id'=>'evose_1', 'name'=>__('Icon Color','eventon'),'type'=>'color', 'default'=> $evo_color_1),			
				...
				array('id'=>'evcal_fcx','type'=>'hiddensection_open','name'=>__('EventTop Styles','eventon'), 'display'=>'none'),
					...
					array('id'=>'evcal_fcx','type'=>'subheader','name'=>__('Colorful EventTop Text Colors','eventon')),
						...
						array('id'=>'evo_ett_colorful_color',
							...
							'options'=> array(
								...
								'auto'=> __('Auto detect white or black text color for eventtop text based on background'),
					...
					array('id'=>'evcal_fcx','type'=>'subheader','name'=>__('Other EventTop Colors','eventon')),
					...
					array('id'=>'fs_eventtop_tag','type'=>'fontation','name'=>__('Virtual Tag','eventon'),
						'variations'=>array(
							...
							array('id'=>'fs_eventtop_est_0b', 'name'=>'Font Color', 'type'=>'color', 'default'=>$evo_color_1),
						)
					),
					...
					array('id'=>'fs_eventtop_tag','type'=>'fontation','name'=>__('Completed Events Tag','eventon'),
						'variations'=>array(
							array('id'=>'fs_eventtop_completed_1', 'name'=>'Background color', 'type'=>'color', 'default'=>'585858'),
							array('id'=>'fs_eventtop_completed_2', 'name'=>'Font Color', 'type'=>'color', 'default'=>$evo_color_1),
						)
					),
					...
					array('id'=>'fs_eventtop_clr18','type'=>'fontation','name'=>__('Event Status Reason Content','eventon'),
						'variations'=>array(
							array('id'=>'fs_eventtop_clr18a', 'name'=>'Text Color', 'type'=>'color', 'default'=> $evo_color_1),
							array('id'=>'fs_eventtop_clr18b', 'name'=>'Background Color', 'type'=>'color', 'default'=>'ffffff'),
						)
					),
				...
				array('id'=>'fs_fonti1','type'=>'fontation','name'=> __('Section Title Text','eventon'),
					'variations'=>array(
						array('id'=>'evcal__fc4', 'type'=>'color', 'default'=>$evo_color_1),
				...
				array('id'=>'evcal_livenow','type'=>'hiddensection_open','name'=>__('Live Now Calendar View Styles','eventon'), 'display'=>'none'),
					...
					array('id'=>'evo_live4','type'=>'fontation','name'=>__('Coming Up Counter','eventon'),
						'variations'=>array(
							...
							array('id'=>'evo_live4b', 'name'=>__('Background Color','eventon'), 'type'=>'color', 'default'=> $evo_color_1),
						)
					),	
